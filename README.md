...
- `docs/current/传感器分类与取舍决策_V1.md`：按必需、建议、试点、可选划分传感器，明确采购和施工预留决策。
- `docs/current/明日设计师沟通要点_2026-07-05.md`：明天与设计师确认强电、弱电、RS-485、水路和柜体遮挡的简明会议口径。
- `docs/current/明日设计师点位图套件_2026-07-05.md`：基于新版平面图绘制的弱电、强电、智能/安全/RS-485 推荐点位图和编号说明。
- `docs/current/装修队强弱电必要确认_2026-07-07.md`：基于设计师当前强弱电图的极简施工队确认材料。
- `docs/current/设计师点位参考方案_V1.md`：可直接给设计师转成施工图的强电、弱电、天花、RS-485、水路安全和房间级参考点位方案。
- `docs/current/给设计师的点位落图输入_V1.md`：给设计师的强电、弱电、RS-485、天花、水路、安全和柜体遮挡落图输入。
- `docs/current/周末设计师点位图制作基准与优先级_V1.md`：周末给设计师制作强电、弱电、天花设备和传感器点位图的底图、图层和优先级。
...
- `diagrams/09_设计师点位图_弱电网络.png`、`10_设计师点位图_强电固定设备.png`、`11_设计师点位图_智能安全_RS485.png`：基于新版平面图的设计师沟通用点位图。
- `diagrams/12_强弱电点位图_业主必要标注.png`、`13_强弱电点位图_施工队简版.png`：直接叠加在设计师强弱电点位图上的业主必要确认图，建议施工队优先看简版。
...
- 书房作为办公室，3090 工作站放书房，保留 2×Cat6A。
- 儿童房/次卧可能放台式机，保留 2×Cat6A。
- 主卧不设固定网口。
- 衣帽间用作网络与自动化设备间。
- 洗衣机固定在次卫生间。
- 客厅投影仪按新版平面图幕布位置协调。
- P2S 确认放入衣帽间；按独立台面/独立插座/不接机柜 UPS 设计，PLA/PETG 不强制外排，但保留通风或外排条件。
- 客厅阳台保留 1 个备用网口。
